...
$("#btnAdd").click(function () {
    ...
    var id_cuoi = $(".BangGiaThamKhao").find("tr:last-child");
    /*i = parseInt(id_cuoi) + 1;*/
    // Bước 1: Nội dung phía trong thẻ trAppend
    var tdnoidung = $(".trAppend").html();
    // Bước 2: Tạo 1 thẻ div bao ngoài nội dung
    var divnoidung = "<div class=\"trAppended\">" + tdnoidung + "</div>";
    // Bước 3: Lấy thẻ table append vào 1 div
    $(".BangGiaThamKhao").append(divnoidung);
    loadIDLENTHE();
});
